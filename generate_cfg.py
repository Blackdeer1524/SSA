...
from src.cfg.dominators import DominatorComputer, draw_dom_frontier, draw_dom_tree_edges
...
def main():
    ...
    frontier = computer.dominance_frontier()
    ...
    print(draw_dom_frontier(frontier))
    print("}")
